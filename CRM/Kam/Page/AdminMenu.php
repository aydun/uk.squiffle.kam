...
class CRM_Kam_Page_AdminMenu extends CRM_Core_Page {
  ...
  public function run() {
    if (CRM_Core_Session::singleton()->get('userID')) {
      ...
      // see comment for kam_civicrm_navigationMenu()
      ...
      print $smarty->fetchWith('CRM/Kam/Page/navigation.js.tpl', array(
        'navigation' => $nav,
      ));
    }
